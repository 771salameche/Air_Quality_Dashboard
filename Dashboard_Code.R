...
#                                              READING THE FILES
#  --------------------------------------------------------------------------------------------------------
title <- tags$img(src='logo.png',height='50', width='46'," Air Quality")
...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Visit Us", icon = icon("send", lib = "glyphicon"), href = "https://github.com/zakariaeyahya/DASH_AIR_QUALITY.git")
    )
  ),
  ...
  dashboardBody(
    ...
    tabItems(
      ...
      tabItem(
        ...
        br(),
        fluidRow(
          column(width = 12, tags$h2("Ramadan mubarak🌙"))
        ),
        fluidRow(
          column(
            width = 12,
            tags$h2("Introduction au tableau de bord de la qualité de l’air en Inde"),
            tags$p(
              ...
              <table style="width:125%; border:0px;">
                <tr>
                  <td>
                    ...
                    cannot be addressed
                    in isolation and there are no easy or quick solutions.<br>
                ...
                <tr>
                 ...
                 Tuesday and 295 on Monday, according to the Central Pollution Control Board data.<br>
